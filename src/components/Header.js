        ...
        <section className='bg-Hero bg-cover bg-center  py-4 md:px-24 px-4'>
            ...
            <div className='flex md:flex-row flex-col gap-5 pt-20'>
                <div className='flex-1'>
                    <h1 className='md:text-5xl text-4xl font-semibold tracking-wide md:leading-tight 
                    leading-snug'>Be prepared for the montains and beyond.</h1>
                    <p className='text-gray-600 md:w-2/3 md:py-4 py-2 leading-relaxed'>Are you looking for amazing hiking travel? Don't worry !
                        We got it for you!</p>
                    <br />
            ...
            <p className='py-10 md:text-sm text-xs block text-gray-600 text-center'>
                ...
                <span className='text-rose-600  font-semibold italic px-1'>EXPLORE ALL TREKKING.</span>
            </p>
        </section >
    );
};
